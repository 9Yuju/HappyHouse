            ...
            function (result, status) {
              ...
              if (status === kakao.maps.services.Status.OK) {
                ...
                kakao.maps.event.addListener(marker, "click", function () {
                  ...
                  content +=
                    '    <div class="tel row" style="display: flex; justify-content: center;">' +
                    '<div class="col-1"></div>' +
                    '<div class="col-10 row text-center pt-3" style="display: flex; justify-content: center;">' +
                    '   <a class="tel" href="' +
                    ...
                    '" target="_blank" title="' +
                    result[0].road_address.building_name +
                    '"style="color: rgb(65, 132, 229);" >' +
                    "로드뷰" +
                    '</a> <p style="color : rgb(65, 132, 229)">&nbsp;|&nbsp;</p>' +
                    '   <a class="tel" href="' +
  ...
  methods: {
    initMap() {
      ...
      function displayPlaceInfo(place) {
        ...
        content +=
          '    <span class="tel" style="padding:5px 20px 0">' +
          place.phone +
          "</span>" +
          "</div>" +
          '<div class="after"></div>';
